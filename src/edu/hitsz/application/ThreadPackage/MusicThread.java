...
public class MusicThread implements Runnable {
    ...
    private final boolean musicType;
    ...
    public MusicThread(String filename, boolean musicType) {
        //初始化filename
    ...
    public void play(InputStream source) {
        ...
        try {
            int numBytesRead = 0;
            while (numBytesRead != -1 && !terminateFlag) {
    ...
    public void run() {
        ...
        play(stream);
        if(musicType){
            MusicProxyThread.musicEndFlag = true;
        }
    }
