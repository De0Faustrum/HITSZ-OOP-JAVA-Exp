...
public class ImageManager {
    ...
    public static BufferedImage SE_BOSS_COMING;

    public ImageManager() {
        try {
            switch (StaticConfiguration.difficultyMode){
                case 1: backgroundImage = ImageIO.read(new FileInputStream("src/images/bg.jpg"));
                        break;
                case 2: backgroundImage = ImageIO.read(new FileInputStream("src/images/bg2.jpg"));
                        break;
                case 3: backgroundImage = ImageIO.read(new FileInputStream("src/images/bg5.jpg"));
                        break;
                default:break;
            }
        } catch (IOException e) {
    ...
    static {
        try {
            ...
            SE_BOSS_COMING = ImageIO.read(new FileInputStream("src/images/danger.png"));
